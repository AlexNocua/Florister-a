 ...
 * @author Angie
 */
public class producto1 extends Floristeria {

    public producto1(String tipodeflor, String colordisponible1, String colordisponible2, String colordisponible3, String colordisponible4, int costounidad, int costoramo, int costoramode24) {
